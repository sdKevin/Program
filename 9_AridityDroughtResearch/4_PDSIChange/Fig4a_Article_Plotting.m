function Fig4a_Article_Plotting(PDSI_Year)
...
PDSI_Princeton_PM_RC_CO2_Jarvis_H = PDSI_Year(6).DroughtExtent_Year.SevereDrought_pdsi_PM_RC_CO2_Jarvis_H;
PDSI_Princeton_PM_RC_CO2_Yang = PDSI_Year(6).DroughtExtent_Year.SevereDrought_pdsi_PM_RC_CO2_Yang;
PDSI_Princeton_PM_RC = PDSI_Year(6).DroughtExtent_Year.SevereDrought_pdsi_PM_RC;
