function Fig5c_Plotting(PDSI_Year)
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical PDSI calculated by PM-RC-Jarvis-H
PDSI_Historical = PDSI_Year(1).DroughtFrequency_GMYear.ModerateDrought_pdsi_PM_RC;
Ensemble_Mean_PDSI_Historical = nanmean(PDSI_Historical)';
c95_PDSI_Historical = (std(PDSI_Historical)./sqrt(size(PDSI_Historical,1))).*1.28;% 80% confidence interval
c95_PDSI_Historical = c95_PDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    PDSI_ssp = PDSI_Year(i_ssp).DroughtFrequency_GMYear.ModerateDrought_pdsi_PM_RC;
    PDSI_ssp = [PDSI_Historical(:,end) , PDSI_ssp];
    Ensemble_Mean_PDSI_ssp(:,i_ssp-1) = nanmean(PDSI_ssp)';
    c95_PDSI_ssp = (std(PDSI_ssp)./sqrt(size(PDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_PDSI_ssp = c95_PDSI_ssp';
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical PDSI calculated by PM-RC-Jarvis-H
PDSI_Historical = PDSI_Year(1).DroughtFrequency_GMYear.MildDrought_pdsi_PM_RC;
Ensemble_Mean_PDSI_Historical = nanmean(PDSI_Historical)';
c95_PDSI_Historical = (std(PDSI_Historical)./sqrt(size(PDSI_Historical,1))).*1.28;% 80% confidence interval
c95_PDSI_Historical = c95_PDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    PDSI_ssp = PDSI_Year(i_ssp).DroughtFrequency_GMYear.MildDrought_pdsi_PM_RC;
    PDSI_ssp = [PDSI_Historical(:,end) , PDSI_ssp];
    Ensemble_Mean_PDSI_ssp(:,i_ssp-1) = nanmean(PDSI_ssp)';
    c95_PDSI_ssp = (std(PDSI_ssp)./sqrt(size(PDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_PDSI_ssp = c95_PDSI_ssp';
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical PDSI calculated by PM-RC-Jarvis-H
PDSI_Historical = PDSI_Year(1).DroughtFrequency_GMYear.SevereMoist_pdsi_PM_RC;
Ensemble_Mean_PDSI_Historical = nanmean(PDSI_Historical)';
c95_PDSI_Historical = (std(PDSI_Historical)./sqrt(size(PDSI_Historical,1))).*1.28;% 80% confidence interval
c95_PDSI_Historical = c95_PDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    PDSI_ssp = PDSI_Year(i_ssp).DroughtFrequency_GMYear.SevereMoist_pdsi_PM_RC;
    PDSI_ssp = [PDSI_Historical(:,end) , PDSI_ssp];
    Ensemble_Mean_PDSI_ssp(:,i_ssp-1) = nanmean(PDSI_ssp)';
    c95_PDSI_ssp = (std(PDSI_ssp)./sqrt(size(PDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_PDSI_ssp = c95_PDSI_ssp';
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical PDSI calculated by PM-RC-Jarvis-H
PDSI_Historical = PDSI_Year(1).DroughtFrequency_GMYear.ModerateMoist_pdsi_PM_RC;
Ensemble_Mean_PDSI_Historical = nanmean(PDSI_Historical)';
c95_PDSI_Historical = (std(PDSI_Historical)./sqrt(size(PDSI_Historical,1))).*1.28;% 80% confidence interval
c95_PDSI_Historical = c95_PDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    PDSI_ssp = PDSI_Year(i_ssp).DroughtFrequency_GMYear.ModerateMoist_pdsi_PM_RC;
    PDSI_ssp = [PDSI_Historical(:,end) , PDSI_ssp];
    Ensemble_Mean_PDSI_ssp(:,i_ssp-1) = nanmean(PDSI_ssp)';
    c95_PDSI_ssp = (std(PDSI_ssp)./sqrt(size(PDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_PDSI_ssp = c95_PDSI_ssp';
...
YlimRange_PDSI = [2.8,4.5]; YTickRange_PDSI = [3 : 0.5 : 4.5];
%% Three time windows
%  Contemporary: 1948-2014
fill([1948;2014;2014;1948],...
    [YlimRange_PDSI(1); YlimRange_PDSI(1); YlimRange_PDSI(2); YlimRange_PDSI(2)],...
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical PDSI calculated by PM-RC-Jarvis-H
PDSI_Historical = PDSI_Year(1).DroughtFrequency_GMYear.MildMoist_pdsi_PM_RC;
Ensemble_Mean_PDSI_Historical = nanmean(PDSI_Historical)';
c95_PDSI_Historical = (std(PDSI_Historical)./sqrt(size(PDSI_Historical,1))).*1.28;% 80% confidence interval
c95_PDSI_Historical = c95_PDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    PDSI_ssp = PDSI_Year(i_ssp).DroughtFrequency_GMYear.MildMoist_pdsi_PM_RC;
    PDSI_ssp = [PDSI_Historical(:,end) , PDSI_ssp];
    Ensemble_Mean_PDSI_ssp(:,i_ssp-1) = nanmean(PDSI_ssp)';
    c95_PDSI_ssp = (std(PDSI_ssp)./sqrt(size(PDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_PDSI_ssp = c95_PDSI_ssp';
