...
%     'Color',[1 1 1],'EraseMode','xor','Linewidth',2.5);
plot([1948:2014],scPDSI_Princeton_PM_RC_CO2_Jarvis_H,...
    'Color',[1 1 1],'EraseMode','xor','Linewidth',2.5); hold on;
plot([1948:2014],scPDSI_Princeton_PM_RC_CO2_Yang,...
    'Color',[1 1 1],'EraseMode','xor','Linewidth',2.5);
plot([1948:2014],scPDSI_Princeton_PM_RC,...
    'Color',[1 1 1],'EraseMode','xor','Linewidth',2.5);
set(gca,'visible','off','TickDir','out','yaxislocation','right','ylim',YlimRange_scPDSI,'xlim',[1948,2100]);
...
plot([1948:2014],scPDSI_Princeton_PM_RC_CO2_Jarvis_H,'--',...
    'Color',1.0-1*(1.0-[102,189,99]./255),'EraseMode','xor','Linewidth',2.5);% 1为透明度
h = legend('PM-RC','PM-RC-Yang','PM-RC-Jarvis');
