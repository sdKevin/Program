...
% Drawing AI calculated by PM_RC_CO2_Jarvis_H
    ...
    for iii = 1 : size(ETrc_Year(ii).ETrc_Year.PM_RC_CO2_Jarvis_H,1)
        ...
        if ii == 4 & iii>=16
            ...
            ETrc_Year(ii).ETrc_Year.PM_RC_CO2_Jarvis_H(iii,:) = ...
                ETrc_Year(ii).ETrc_Year.PM_RC_CO2_Jarvis_H(iii,:) - ...
                (mean(ETrc_Year(1).ETrc_Year.PM_RC_CO2_Jarvis_H(iii+1,99:end)) - mean(ETrc_Year(6).ETrc_Year.PM_RC_CO2_Jarvis_H));
            % ETrc_Year Smooth
            ETrc_Year(ii).ETrc_Year.PM_RC_CO2_Jarvis_H(iii,:) = ...
            ...
            ETrc_Year(ii).ETrc_Year.PM_RC_CO2_Jarvis_H(iii,:) = ...
                ETrc_Year(ii).ETrc_Year.PM_RC_CO2_Jarvis_H(iii,:) - ...
                (mean(ETrc_Year(1).ETrc_Year.PM_RC_CO2_Jarvis_H(iii,99:end)) - mean(ETrc_Year(6).ETrc_Year.PM_RC_CO2_Jarvis_H));
            % ETrc_Year Smooth
            ETrc_Year(ii).ETrc_Year.PM_RC_CO2_Jarvis_H(iii,:) = ...
                smooth(ETrc_Year(ii).ETrc_Year.PM_RC_CO2_Jarvis_H(iii,:) , 7);
            % Met_Year Bias Correction
...
% ScenarioMIP AI calculated by PM-RC-Jarvis-H
% pr kg/(m2s), ETrc mm/day
for i_ssp = [5,4,3,2]
    if i_ssp == 4
        AI_Historical = (Met_Year(1).Met_Year.pr .* 1000.*31536000./997) ./ ...
