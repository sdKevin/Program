function FigS1_Land_Timeseries_Frequency(Met_Drought_Frequency_Year)
...
XlimRange = [1950,2100];
YlimRange_CD = [0.5,4.5]; YTickRange_CD = [1:2:4.5];
%% Plotting Shade Area
...
for i_ssp = [5,4,3,2]
    ...
    CD_ssp = Met_Drought_Frequency_Year(i_ssp).DroughtFrequency_Year.CompoundDrought;
...
try
    ...
    Ensemble_Mean_CD_Historical = nanmean(CD_Historical)';
    c95_CD_Historical = (std(CD_Historical)./sqrt(size(CD_Historical,1))) .* 1.96; % 95% confidence interval
    text(1975,4,strcat( '[' , num2str(mean(Ensemble_Mean_CD_Historical(102:151)),3),'¡À' ,...
...
try
    ...
    text(2051,1.4,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp585(37:86)),3),'¡À' ,...
    ...
    text(2051,0.8,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp245(37:86)),3),'¡À' ,...
    ...
    text(2076 , 0.8 , strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp126(37:86)),3),'¡À' ,...
    ...
    text(2076,1.4,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp370(37:86)),3),'¡À' ,...
...
try
    ...
    text(2001,4,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp585(152:201)),3),'¡À' ,...
    ...
    text(2001,3.5,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp245(152:201)),3),'¡À' ,...
    ...
    text(2026,3.5,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp126(152:201)),3),'¡À' ,...
    ...
    text(2026,4,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp370(152:201)),3),'¡À' ,...
...
set(gca,'visible','off')
clearvars -except Met_Drought_Frequency_Year
end
