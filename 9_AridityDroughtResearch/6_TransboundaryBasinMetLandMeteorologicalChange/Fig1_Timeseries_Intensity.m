function Fig1_Timeseries_Intensity(Met_Drought_Intensity_Year)
...
XlimRange = [1950,2100];
YlimRange_CD = [0.0525,0.071]; YTickRange_CD = [0.05:0.005:0.071];
%% Plotting Shade Area
...
try
    ...
    text(2051,0.057,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp585(37:86)),'%.3f'),'¡À' ,...
    ...
    text(2051,0.054,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp245(37:86)),'%.3f'),'¡À' ,...
    ...
    text(2076,0.054 , strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp126(37:86)),'%.3f'),'¡À' ,...
    ...
    text(2076,0.057,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp370(37:86)),'%.3f'),'¡À' ,...
...
try
    ...
    text(2001,0.066,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp245(152:201)),'%.3f'),'¡À' ,...
    ...
    text(2026,0.066,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp126(152:201)),'%.3f'),'¡À' ,...
