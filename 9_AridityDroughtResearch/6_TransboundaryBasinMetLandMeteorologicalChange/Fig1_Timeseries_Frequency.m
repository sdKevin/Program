function Fig1_Timeseries_Frequency(Met_Drought_Frequency_Year)
...
XlimRange = [1950,2100];
YlimRange_CD = [0.5,7]; YTickRange_CD = [1:2:7];
%% Plotting Shade Area
...
try
    ...
    Ensemble_Mean_CD_Historical = nanmean(CD_Historical)';
    c95_CD_Historical = (std(CD_Historical)./sqrt(size(CD_Historical,1))) .* 1.96; % 95% confidence interval
    text(1980,1.05,strcat( '[' , num2str(mean(Ensemble_Mean_CD_Historical(102:151)),3),'¡À' ,...
...
try
    ...
    text(2051,2.0,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp585(37:86)),3),'¡À' ,...
    ...
    text(2051,1.1,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp245(37:86)),3),'¡À' ,...
    ...
    text(2076 , 1.1 , strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp126(37:86)),3),'¡À' ,...
    ...
    text(2076,2.0,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp370(37:86)),3),'¡À' ,...
...
try
    ...
    text(2001,6.3,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp585(152:201)),3),'¡À' ,...
    ...
    text(2001,5.4,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp245(152:201)),3),'¡À' ,...
    ...
    text(2026,5.4,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp126(152:201)),3),'¡À' ,...
    ...
    text(2026,6.3,strcat( '[' , num2str(mean(Ensemble_Mean_CD_ssp370(152:201)),3),'¡À' ,...
