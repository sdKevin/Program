...
save('Met_Drought_Land_Frequency_Intensity_Extent' , 'Met_Drought_Frequency_Year' , 'Met_Drought_Intensity_Year' , 'Met_Drought_Extent_Year');
...
subplot(3,1,1)
FigS1_Land_Timeseries_Extent(Met_Drought_Extent_Year)
subplot(3,1,2)
FigS1_Land_Timeseries_Intensity(Met_Drought_Intensity_Year)
subplot(3,1,3)
FigS1_Land_Timeseries_Frequency(Met_Drought_Frequency_Year)
