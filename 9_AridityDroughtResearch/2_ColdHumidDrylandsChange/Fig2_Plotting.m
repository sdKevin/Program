function Fig2_Plotting(GridAI_Princeton_ScenarioMIP , Path_Fig1b_Output)
...
for i_ssp = 1 : length(ssp)
    ...
    [Cold_Humid(i_ssp,:) , Cold_Dry(i_ssp,:)] = Fig2_TransferMatrix(AI_PM_RC_Princeton , AI_PM_RC_CO2_Yang_Princeton ,...
