function Fig1b_GlobalLands_Right_Plotting(CMIP_DryWetRegion)
%% Setting Color
...
%% Setting axis range
YlimRange_Cold = [8 , 16]; YTickRange_Cold = 8 : 2 : 16;
YlimRange_Dry_Humid = [41 , 49]; YTickRange_Dry_Humid = 41 : 2 : 49;

%% Plotting DryLand Area Ratio Under ssp126 , 245 & 585
figure
subplot(1,6,[1:3])
H = notBoxPlot([mean(CMIP_DryWetRegion(2).DryLand_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(3).DryLand_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(5).DryLand_PM_RC_CO2_Yang(:,end-30:end-1)')'],'jitter',0.3);
...
H = notBoxPlot([mean(CMIP_DryWetRegion(2).Cold_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(3).Cold_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(5).Cold_PM_RC_CO2_Yang(:,end-30:end-1)')'],'jitter',0.4);
...
axes('position', get(gca,'Position'));
H = notBoxPlot([mean(CMIP_DryWetRegion(2).HumidLand_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(3).HumidLand_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(5).HumidLand_PM_RC_CO2_Yang(:,end-30:end-1)')'],'jitter',0.3);
set(gca,'color',[ 255 255 255]./255,'Box','On')
set([H.data],'MarkerSize',6,...
    'markerFaceColor','none',...
    'markerEdgeColor', 'none')
...
H = notBoxPlot([mean(CMIP_DryWetRegion(4).DryLand_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(4).DryLand_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(4).DryLand_PM_RC_CO2_Yang(:,end-30:end-1)')'],'jitter',0.3);
...
axes('position', get(gca,'Position'));
H = notBoxPlot([mean(CMIP_DryWetRegion(4).Cold_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(4).Cold_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(4).Cold_PM_RC_CO2_Yang(:,end-30:end-1)')'],'jitter',0.4);
set(gca,'color',[ 255 255 255]./255,'Box','On')
set([H.data],'MarkerSize',6,...
    'markerFaceColor','none',...
    'markerEdgeColor', 'none')
...
H = notBoxPlot([mean(CMIP_DryWetRegion(4).HumidLand_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(4).HumidLand_PM_RC_CO2_Yang(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(4).HumidLand_PM_RC_CO2_Yang(:,end-30:end-1)')'],'jitter',0.3);
set(gca,'color',[ 255 255 255]./255,'Box','On')
set([H.data],'MarkerSize',6,...
    'markerFaceColor','none',...
    'markerEdgeColor', 'none')
