...
figure
%%%%%%%%%%%%%%%%%%%%%Shade Area
RGB_Yang_Shade = [191,215,240];RGB_Yang_Line = [133,184,227];
RGB_PM_Shade = [218,195,149];RGB_PM_Line = [172,150,83];
RGB_Jarvis_Shade = [205,203,229];RGB_Jarvis_Line = [100,101,174];
YlimRange_AI = [0.67,0.86];YTickRange_AI = [0.65:0.04:0.88];
%% Three Windows
fill([1850;1879;1879;1850],[YlimRange_AI(1);YlimRange_AI(1);YlimRange_AI(2);YlimRange_AI(2)],...
    [240,240,242]./255,'EdgeAlpha',0,'FaceAlpha',0.9);hold on;
fill([1948;2014;2014;1948],[YlimRange_AI(1);YlimRange_AI(1);YlimRange_AI(2);YlimRange_AI(2)],...
    [240,240,242]./255,'EdgeAlpha',0,'FaceAlpha',0.9);
fill([2070;2099;2099;2070],[YlimRange_AI(1);YlimRange_AI(1);YlimRange_AI(2);YlimRange_AI(2)],...
    [240,240,242]./255,'EdgeAlpha',0,'FaceAlpha',0.9);
...
plot([1948:2014],smooth(AI_PM_RC_CO2_Jarvis_H + 0.005,7),...
