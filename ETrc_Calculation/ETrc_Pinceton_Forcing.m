...
[PM_RC_CO2_Yang , PM_RC_CO2_Jarvis_H , PM_RC_CO2_Jarvis_L] =...
    ...
    OutputPath_Attribution , OutputPath_InterVar , 'Princeton');

%% Save the result
save(strcat(OutputPath_ETrc , '\PM_RC_Princeton'),'PM_RC');
save(strcat(OutputPath_ETrc , '\PM_RC_CO2_Yang_Princeton'),'PM_RC_CO2_Yang');
save(strcat(OutputPath_ETrc , '\PM_RC_CO2_Jarvis_H_Princeton'),'PM_RC_CO2_Jarvis_H');
save(strcat(OutputPath_ETrc , '\PM_RC_CO2_Jarvis_L_Princeton'),'PM_RC_CO2_Jarvis_L');
