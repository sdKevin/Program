...
for i_Path = 1 : length(InputETrcPath)
    ...
    for i_GCM = 1 : length(GCM_Ensemble)
        ...
        for ii = 1 : size( ETrc.PM_RC , 3)
            Cold_PM_RC(i_GCM,ii) = nansum(EarthLandArea_05deg([(ETrc.PM_RC(:,1:250,ii))<400,(ETrc.PM_RC(:,251:end,ii))<400]))...
            ...
            Cold_PM_RC_CO2_Jarvis_H(i_GCM,ii) = nansum(EarthLandArea_05deg([(ETrc.PM_RC_CO2_Jarvis_H(:,1:250,ii))<400,(ETrc.PM_RC_CO2_Jarvis_H(:,251:end,ii))<400]))...
                ./nansum(nansum(EarthLandArea_05deg(~isnan(landmask_05deg)))) .* 100;
            ...
            Cold_PM_RC_CO2_Yang(i_GCM,ii) = nansum(EarthLandArea_05deg([(ETrc.PM_RC_CO2_Yang(:,1:250,ii))<400,(ETrc.PM_RC_CO2_Yang(:,251:end,ii))<400]))...
                ./nansum(nansum(EarthLandArea_05deg(~isnan(landmask_05deg)))) .* 100;
...
for ii = 1 : size( ETrc.PM_RC,3)
    ...
    Cold_PM_RC_CO2_Jarvis_H(1,ii) = nansum(EarthLandArea_05deg([(ETrc.PM_RC_CO2_Jarvis_H(:,1:250,ii))<400,(ETrc.PM_RC_CO2_Jarvis_H(:,251:end,ii))<400]))...
        ./nansum(nansum(EarthLandArea_05deg(~isnan(landmask_05deg)))) .* 100;
    ...
    Cold_PM_RC_CO2_Yang(1,ii) = nansum(EarthLandArea_05deg([(ETrc.PM_RC_CO2_Yang(:,1:250,ii))<400,(ETrc.PM_RC_CO2_Yang(:,251:end,ii))<400]))...
        ./nansum(nansum(EarthLandArea_05deg(~isnan(landmask_05deg)))) .* 100;
