function Fig1_Right_Plotting(Met_Land_Year)
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Pr %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure
subplot(1,8,[1:4])
...
for i_ssp = [5 , 3 , 2]
    ...
    Pr_ssp(:,:,i_ssp-1) = Met_Land_Year(i_ssp).DroughtExtent_Year.Pr;
end
...
subplot(1,8,[5:8])
for i_ssp = 4
    Pr_ssp370 = Met_Land_Year(i_ssp).DroughtExtent_Year.Pr;
end
...
subplot(1,8,[5:8])
for i_ssp = 4
    Pr_ET_ssp370 = Met_Land_Year(i_ssp).DroughtExtent_Year.Pr_ET;
end
...
for i_ssp = [5 , 3 , 2]
    ...
    Q_ssp(:,:,i_ssp-1) = Met_Land_Year(i_ssp).DroughtExtent_Year.Q;
end
...
subplot(1,8,[5:8])
for i_ssp = 4
    Q_ssp370 = Met_Land_Year(i_ssp).DroughtExtent_Year.Q;
end
...
for i_ssp = [5 , 3 , 2]
    ...
    SM_ssp(:,:,i_ssp-1) = Met_Land_Year(i_ssp).DroughtExtent_Year.SM;
end
...
subplot(1,8,[5:8])
for i_ssp = 4
    SM_ssp370 = Met_Land_Year(i_ssp).DroughtExtent_Year.SM;
end
