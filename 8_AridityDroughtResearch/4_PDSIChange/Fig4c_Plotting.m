function Fig4c_Plotting(PDSI_Year)
% Drawing Drought Extent calculated by PDSI PM_RC
...
YlimRange_PDSI = [5,40]; YTickRange_PDSI = [5 : 10 : 40];
%% Three time windows
...
PDSI_Historical = PDSI_Year(1).DroughtExtent_Year.SevereDrought_pdsi_PM_RC;
...
for i_ssp = [5,4,3,2]
    ...
    PDSI_ssp = PDSI_Year(i_ssp).DroughtExtent_Year.SevereDrought_pdsi_PM_RC;
...
YlimRange_PDSI = [15,45]; YTickRange_PDSI = [15 : 10 : 45];
%% Three time windows
%  Contemporary: 1948-2014
fill([1948;2014;2014;1948],...
    [YlimRange_PDSI(1); YlimRange_PDSI(1); YlimRange_PDSI(2); YlimRange_PDSI(2)],...
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical PDSI calculated by PM-RC-Jarvis-H
PDSI_Historical = PDSI_Year(1).DroughtExtent_Year.ModerateDrought_pdsi_PM_RC;
Ensemble_Mean_PDSI_Historical = nanmean(PDSI_Historical)';
c95_PDSI_Historical = (std(PDSI_Historical)./sqrt(size(PDSI_Historical,1))).*1.28;% 80% confidence interval
c95_PDSI_Historical = c95_PDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    PDSI_ssp = PDSI_Year(i_ssp).DroughtExtent_Year.ModerateDrought_pdsi_PM_RC;
    PDSI_ssp = [PDSI_Historical(:,end) , PDSI_ssp];
    Ensemble_Mean_PDSI_ssp(:,i_ssp-1) = nanmean(PDSI_ssp)';
    c95_PDSI_ssp = (std(PDSI_ssp)./sqrt(size(PDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_PDSI_ssp = c95_PDSI_ssp';
...
YlimRange_PDSI = [30,55]; YTickRange_PDSI = [20 : 10 : 55];
%% Three time windows
%  Contemporary: 1948-2014
fill([1948;2014;2014;1948],...
    [YlimRange_PDSI(1); YlimRange_PDSI(1); YlimRange_PDSI(2); YlimRange_PDSI(2)],...
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical PDSI calculated by PM-RC-Jarvis-H
PDSI_Historical = PDSI_Year(1).DroughtExtent_Year.MildDrought_pdsi_PM_RC;
Ensemble_Mean_PDSI_Historical = nanmean(PDSI_Historical)';
c95_PDSI_Historical = (std(PDSI_Historical)./sqrt(size(PDSI_Historical,1))).*1.28;% 80% confidence interval
c95_PDSI_Historical = c95_PDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    PDSI_ssp = PDSI_Year(i_ssp).DroughtExtent_Year.MildDrought_pdsi_PM_RC;
    PDSI_ssp = [PDSI_Historical(:,end) , PDSI_ssp];
    Ensemble_Mean_PDSI_ssp(:,i_ssp-1) = nanmean(PDSI_ssp)';
    c95_PDSI_ssp = (std(PDSI_ssp)./sqrt(size(PDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_PDSI_ssp = c95_PDSI_ssp';
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical PDSI calculated by PM-RC-Jarvis-H
PDSI_Historical = PDSI_Year(1).DroughtExtent_Year.SevereMoist_pdsi_PM_RC;
Ensemble_Mean_PDSI_Historical = nanmean(PDSI_Historical)';
c95_PDSI_Historical = (std(PDSI_Historical)./sqrt(size(PDSI_Historical,1))).*1.28;% 80% confidence interval
c95_PDSI_Historical = c95_PDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    PDSI_ssp = PDSI_Year(i_ssp).DroughtExtent_Year.SevereMoist_pdsi_PM_RC;
    PDSI_ssp = [PDSI_Historical(:,end) , PDSI_ssp];
    Ensemble_Mean_PDSI_ssp(:,i_ssp-1) = nanmean(PDSI_ssp)';
    c95_PDSI_ssp = (std(PDSI_ssp)./sqrt(size(PDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_PDSI_ssp = c95_PDSI_ssp';
...
YlimRange_PDSI = [10,30]; YTickRange_PDSI = [10 : 5 : 30];
%% Three time windows
%  Contemporary: 1948-2014
fill([1948;2014;2014;1948],...
    [YlimRange_PDSI(1); YlimRange_PDSI(1); YlimRange_PDSI(2); YlimRange_PDSI(2)],...
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical PDSI calculated by PM-RC-Jarvis-H
PDSI_Historical = PDSI_Year(1).DroughtExtent_Year.ModerateMoist_pdsi_PM_RC;
Ensemble_Mean_PDSI_Historical = nanmean(PDSI_Historical)';
c95_PDSI_Historical = (std(PDSI_Historical)./sqrt(size(PDSI_Historical,1))).*1.28;% 80% confidence interval
c95_PDSI_Historical = c95_PDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    PDSI_ssp = PDSI_Year(i_ssp).DroughtExtent_Year.ModerateMoist_pdsi_PM_RC;
    PDSI_ssp = [PDSI_Historical(:,end) , PDSI_ssp];
    Ensemble_Mean_PDSI_ssp(:,i_ssp-1) = nanmean(PDSI_ssp)';
    c95_PDSI_ssp = (std(PDSI_ssp)./sqrt(size(PDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_PDSI_ssp = c95_PDSI_ssp';
...
YlimRange_PDSI = [25,40]; YTickRange_PDSI = [25 : 5 : 40];
%% Three time windows
%  Contemporary: 1948-2014
fill([1948;2014;2014;1948],...
    [YlimRange_PDSI(1); YlimRange_PDSI(1); YlimRange_PDSI(2); YlimRange_PDSI(2)],...
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical PDSI calculated by PM-RC-Jarvis-H
PDSI_Historical = PDSI_Year(1).DroughtExtent_Year.MildMoist_pdsi_PM_RC;
Ensemble_Mean_PDSI_Historical = nanmean(PDSI_Historical)';
c95_PDSI_Historical = (std(PDSI_Historical)./sqrt(size(PDSI_Historical,1))).*1.28;% 80% confidence interval
c95_PDSI_Historical = c95_PDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    PDSI_ssp = PDSI_Year(i_ssp).DroughtExtent_Year.MildMoist_pdsi_PM_RC;
    PDSI_ssp = [PDSI_Historical(:,end) , PDSI_ssp];
    Ensemble_Mean_PDSI_ssp(:,i_ssp-1) = nanmean(PDSI_ssp)';
    c95_PDSI_ssp = (std(PDSI_ssp)./sqrt(size(PDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_PDSI_ssp = c95_PDSI_ssp';
