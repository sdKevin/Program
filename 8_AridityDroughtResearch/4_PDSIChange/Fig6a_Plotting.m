...
clear i_lat i_lon
k_SevereDrought_PDSI_PM_RC_Princeton_Year(isnan(k_SevereDrought_PDSI_PM_RC_Princeton_Year)) = -9999;
SaveData2GeoTIFF([Path_Fig6a_Output 'k_SevereDrought_PDSI_PM_RC_Princeton'],extent,k_SevereDrought_PDSI_PM_RC_Princeton_Year');
p_SevereDrought_PDSI_PM_RC_Princeton_Year(isnan(p_SevereDrought_PDSI_PM_RC_Princeton_Year)) = -9999;
SaveData2GeoTIFF([Path_Fig6a_Output 'p_SevereDrought_PDSI_PM_RC_Princeton'],extent,p_SevereDrought_PDSI_PM_RC_Princeton_Year');
clear k_SevereDrought_PDSI_PM_RC_Princeton_Year p_SevereDrought_PDSI_PM_RC_Princeton_Year SevereDrought_PDSI_PM_RC_Princeton
% (2.2) PM_RC_CO2_Yang
...
clear i_lat i_lon
k_SevereDrought_PDSI_PM_RC_CO2_Yang_Princeton_Year(isnan(k_SevereDrought_PDSI_PM_RC_CO2_Yang_Princeton_Year)) = -9999;
SaveData2GeoTIFF([Path_Fig6a_Output 'k_SevereDrought_PDSI_PM_RC_CO2_Yang_Princeton'],extent,k_SevereDrought_PDSI_PM_RC_CO2_Yang_Princeton_Year');
p_SevereDrought_PDSI_PM_RC_CO2_Yang_Princeton_Year(isnan(p_SevereDrought_PDSI_PM_RC_CO2_Yang_Princeton_Year)) = -9999;
SaveData2GeoTIFF([Path_Fig6a_Output 'p_SevereDrought_PDSI_PM_RC_CO2_Yang_Princeton'],extent,p_SevereDrought_PDSI_PM_RC_CO2_Yang_Princeton_Year');
clear k_SevereDrought_PDSI_PM_RC_CO2_Yang_Princeton_Year p_SevereDrought_PDSI_PM_RC_CO2_Yang_Princeton_Year SevereDrought_PDSI_PM_RC_CO2_Yang_Princeton
...
clear i_lat i_lon
k_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Princeton_Year(isnan(k_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Princeton_Year)) = -9999;
SaveData2GeoTIFF([Path_Fig6a_Output 'k_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Princeton'],extent,k_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Princeton_Year');
p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Princeton_Year(isnan(p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Princeton_Year)) = -9999;
SaveData2GeoTIFF([Path_Fig6a_Output 'p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Princeton'],extent,p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Princeton_Year');
clear k_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Princeton_Year p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Princeton_Year SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Princeton
...
for i_ssp = 1 : length(ssp)
    ...
    SaveData2GeoTIFF([Path_Fig6a_Output 'p_SevereDrought_PDSI_PM_RC_' ssp{i_ssp}],extent,p_SevereDrought_PDSI_PM_RC_CMIP_Year');
    clear k_SevereDrought_PDSI_PM_RC_CMIP_Year p_SevereDrought_PDSI_PM_RC_CMIP_Year SevereDrought_PDSI_PM_RC_CMIP
    % (3.2) PM_RC_CO2_Yang
    ...
    SaveData2GeoTIFF([Path_Fig6a_Output 'p_SevereDrought_PDSI_PM_RC_CO2_Yang_' ssp{i_ssp}],extent,p_SevereDrought_PDSI_PM_RC_CO2_Yang_CMIP_Year');
    clear k_SevereDrought_PDSI_PM_RC_CO2_Yang_CMIP_Year p_SevereDrought_PDSI_PM_RC_CO2_Yang_CMIP_Year SevereDrought_PDSI_PM_RC_CO2_Yang_CMIP
    ...
    SaveData2GeoTIFF([Path_Fig6a_Output 'p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_' ssp{i_ssp}],extent,p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_CMIP_Year');
    clear k_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_CMIP_Year p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_CMIP_Year SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_CMIP
end
...
p_SevereDrought_PDSI_PM_RC_CMIP_Year(isnan(p_SevereDrought_PDSI_PM_RC_CMIP_Year)) = -9999;
SaveData2GeoTIFF([Path_Fig6a_Output 'p_SevereDrought_PDSI_PM_RC_Historical'],extent,p_SevereDrought_PDSI_PM_RC_CMIP_Year');
clear k_SevereDrought_PDSI_PM_RC_CMIP_Year p_SevereDrought_PDSI_PM_RC_CMIP_Year SevereDrought_PDSI_PM_RC_CMIP
% (4.2) PM_RC_CO2_Yang
...
p_SevereDrought_PDSI_PM_RC_CO2_Yang_CMIP_Year(isnan(p_SevereDrought_PDSI_PM_RC_CO2_Yang_CMIP_Year)) = -9999;
SaveData2GeoTIFF([Path_Fig6a_Output 'p_SevereDrought_PDSI_PM_RC_CO2_Yang_Historical'],extent,p_SevereDrought_PDSI_PM_RC_CO2_Yang_CMIP_Year');
clear k_SevereDrought_PDSI_PM_RC_CO2_Yang_CMIP_Year p_SevereDrought_PDSI_PM_RC_CO2_Yang_CMIP_Year SevereDrought_PDSI_PM_RC_CO2_Yang_CMIP
...
p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_CMIP_Year(isnan(p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_CMIP_Year)) = -9999;
SaveData2GeoTIFF([Path_Fig6a_Output 'p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_Historical'],extent,p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_CMIP_Year');
clear k_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_CMIP_Year p_SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_CMIP_Year SevereDrought_PDSI_PM_RC_CO2_Jarvis_H_CMIP
