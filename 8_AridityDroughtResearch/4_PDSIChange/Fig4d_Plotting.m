function Fig4d_Plotting(scPDSI_Year)
% Drawing Drought Extent calculated by scPDSI PM_RC_CO2_Jarvis_H
...
scPDSI_Historical = scPDSI_Year(1).DroughtExtent_Year.SevereDrought_scpdsi_PM_RC_CO2_Jarvis_H;
...
for i_ssp = [5,4,3,2]
    ...
    scPDSI_ssp = scPDSI_Year(i_ssp).DroughtExtent_Year.SevereDrought_scpdsi_PM_RC_CO2_Jarvis_H;
...
YlimRange_scPDSI = [15,35]; YTickRange_scPDSI = [15 : 5 : 35];
%% Three time windows
%  Contemporary: 1948-2014
fill([1948;2014;2014;1948],...
    [YlimRange_scPDSI(1); YlimRange_scPDSI(1); YlimRange_scPDSI(2); YlimRange_scPDSI(2)],...
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical scPDSI calculated by PM-RC-Jarvis-H
scPDSI_Historical = scPDSI_Year(1).DroughtExtent_Year.ModerateDrought_scpdsi_PM_RC_CO2_Jarvis_H;
Ensemble_Mean_scPDSI_Historical = nanmean(scPDSI_Historical)';
c95_scPDSI_Historical = (std(scPDSI_Historical)./sqrt(size(scPDSI_Historical,1))).*1.28;% 80% confidence interval
c95_scPDSI_Historical = c95_scPDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    scPDSI_ssp = scPDSI_Year(i_ssp).DroughtExtent_Year.ModerateDrought_scpdsi_PM_RC_CO2_Jarvis_H;
    scPDSI_ssp = [scPDSI_Historical(:,end) , scPDSI_ssp];
    Ensemble_Mean_scPDSI_ssp(:,i_ssp-1) = nanmean(scPDSI_ssp)';
    c95_scPDSI_ssp = (std(scPDSI_ssp)./sqrt(size(scPDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_scPDSI_ssp = c95_scPDSI_ssp';
...
YlimRange_scPDSI = [30,45]; YTickRange_scPDSI = [30 : 5 : 45];
%% Three time windows
%  Contemporary: 1948-2014
fill([1948;2014;2014;1948],...
    [YlimRange_scPDSI(1); YlimRange_scPDSI(1); YlimRange_scPDSI(2); YlimRange_scPDSI(2)],...
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical scPDSI calculated by PM-RC-Jarvis-H
scPDSI_Historical = scPDSI_Year(1).DroughtExtent_Year.MildDrought_scpdsi_PM_RC_CO2_Jarvis_H;
Ensemble_Mean_scPDSI_Historical = nanmean(scPDSI_Historical)';
c95_scPDSI_Historical = (std(scPDSI_Historical)./sqrt(size(scPDSI_Historical,1))).*1.28;% 80% confidence interval
c95_scPDSI_Historical = c95_scPDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    scPDSI_ssp = scPDSI_Year(i_ssp).DroughtExtent_Year.MildDrought_scpdsi_PM_RC_CO2_Jarvis_H;
    scPDSI_ssp = [scPDSI_Historical(:,end) , scPDSI_ssp];
    Ensemble_Mean_scPDSI_ssp(:,i_ssp-1) = nanmean(scPDSI_ssp)';
    c95_scPDSI_ssp = (std(scPDSI_ssp)./sqrt(size(scPDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_scPDSI_ssp = c95_scPDSI_ssp';
...
YlimRange_scPDSI = [5,35]; YTickRange_scPDSI = [5 : 5 : 35];
%% Three time windows
%  Contemporary: 1948-2014
fill([1948;2014;2014;1948],...
    [YlimRange_scPDSI(1); YlimRange_scPDSI(1); YlimRange_scPDSI(2); YlimRange_scPDSI(2)],...
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical scPDSI calculated by PM-RC-Jarvis-H
scPDSI_Historical = scPDSI_Year(1).DroughtExtent_Year.SevereMoist_scpdsi_PM_RC_CO2_Jarvis_H;
Ensemble_Mean_scPDSI_Historical = nanmean(scPDSI_Historical)';
c95_scPDSI_Historical = (std(scPDSI_Historical)./sqrt(size(scPDSI_Historical,1))).*1.28;% 80% confidence interval
c95_scPDSI_Historical = c95_scPDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    scPDSI_ssp = scPDSI_Year(i_ssp).DroughtExtent_Year.SevereMoist_scpdsi_PM_RC_CO2_Jarvis_H;
    scPDSI_ssp = [scPDSI_Historical(:,end) , scPDSI_ssp];
    Ensemble_Mean_scPDSI_ssp(:,i_ssp-1) = nanmean(scPDSI_ssp)';
    c95_scPDSI_ssp = (std(scPDSI_ssp)./sqrt(size(scPDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_scPDSI_ssp = c95_scPDSI_ssp';
...
YlimRange_scPDSI = [10,40]; YTickRange_scPDSI = [10 : 5 : 40];
%% Three time windows
%  Contemporary: 1948-2014
fill([1948;2014;2014;1948],...
    [YlimRange_scPDSI(1); YlimRange_scPDSI(1); YlimRange_scPDSI(2); YlimRange_scPDSI(2)],...
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical scPDSI calculated by PM-RC-Jarvis-H
scPDSI_Historical = scPDSI_Year(1).DroughtExtent_Year.ModerateMoist_scpdsi_PM_RC_CO2_Jarvis_H;
Ensemble_Mean_scPDSI_Historical = nanmean(scPDSI_Historical)';
c95_scPDSI_Historical = (std(scPDSI_Historical)./sqrt(size(scPDSI_Historical,1))).*1.28;% 80% confidence interval
c95_scPDSI_Historical = c95_scPDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    scPDSI_ssp = scPDSI_Year(i_ssp).DroughtExtent_Year.ModerateMoist_scpdsi_PM_RC_CO2_Jarvis_H;
    scPDSI_ssp = [scPDSI_Historical(:,end) , scPDSI_ssp];
    Ensemble_Mean_scPDSI_ssp(:,i_ssp-1) = nanmean(scPDSI_ssp)';
    c95_scPDSI_ssp = (std(scPDSI_ssp)./sqrt(size(scPDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_scPDSI_ssp = c95_scPDSI_ssp';
...
YlimRange_scPDSI = [25,45]; YTickRange_scPDSI = [25 : 5 : 45];
%% Three time windows
%  Contemporary: 1948-2014
fill([1948;2014;2014;1948],...
    [YlimRange_scPDSI(1); YlimRange_scPDSI(1); YlimRange_scPDSI(2); YlimRange_scPDSI(2)],...
...
plot([1948 2100],[0 0],'Color',[189,188,188]./255,'LineWidth',3)
% Historical scPDSI calculated by PM-RC-Jarvis-H
scPDSI_Historical = scPDSI_Year(1).DroughtExtent_Year.MildMoist_scpdsi_PM_RC_CO2_Jarvis_H;
Ensemble_Mean_scPDSI_Historical = nanmean(scPDSI_Historical)';
c95_scPDSI_Historical = (std(scPDSI_Historical)./sqrt(size(scPDSI_Historical,1))).*1.28;% 80% confidence interval
c95_scPDSI_Historical = c95_scPDSI_Historical';
h1 = fill([[1850:2014]';flipud([1850:2014]')],...
...
for i_ssp = [5,4,3,2]
    ...
    scPDSI_ssp = scPDSI_Year(i_ssp).DroughtExtent_Year.MildMoist_scpdsi_PM_RC_CO2_Jarvis_H;
    scPDSI_ssp = [scPDSI_Historical(:,end) , scPDSI_ssp];
    Ensemble_Mean_scPDSI_ssp(:,i_ssp-1) = nanmean(scPDSI_ssp)';
    c95_scPDSI_ssp = (std(scPDSI_ssp)./sqrt(size(scPDSI_ssp,1))).*1.28; % 80% confidence interval
    c95_scPDSI_ssp = c95_scPDSI_ssp';
