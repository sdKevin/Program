function [Cold_Humid , Cold_Dry] = Fig2_TransferMatrix(AI_PM_RC_Princeton , AI_PM_RC_CO2_Yang_Princeton ,...
    AI_PM_RC_CO2_Jarvis_H_Princeton , AI_PM_RC_2070_2099 ,...
    AI_PM_RC_CO2_Yang_2070_2099 , AI_PM_RC_CO2_Jarvis_H_2070_2099 ,...
    Path_Fig2_Output , sspName)
...
xlswrite([Path_Fig2_Output 'TransferMatrix_EnsembleMean.xlsx'] , M_PM_RC , sspName , 'C4:H9');
xlswrite([Path_Fig2_Output 'TransferMatrix_EnsembleMean.xlsx'] , M_PM_RC_Yang , sspName , 'C16:H21');
xlswrite([Path_Fig2_Output 'TransferMatrix_EnsembleMean.xlsx'] , M_PM_RC_Jarvis_H , sspName , 'C28:H33');
...
AI_PM_RC_Princeton(AI_PM_RC_Princeton<6 & AI_PM_RC_Princeton>1) = 2;
AI_PM_RC_CO2_Yang_Princeton(AI_PM_RC_CO2_Yang_Princeton<6 & AI_PM_RC_CO2_Yang_Princeton>1) = 2;
AI_PM_RC_CO2_Jarvis_H_Princeton(AI_PM_RC_CO2_Jarvis_H_Princeton<6 & AI_PM_RC_CO2_Jarvis_H_Princeton>1) = 2;

%% PM_RC_Jarvis_H
% 1948-2014 Humid converted to What
M_PM_RC_Jarvis_H(1,:) =...
    [nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_2070_2099==1&AI_PM_RC_CO2_Jarvis_H_Princeton==1)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_Princeton==1)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_2070_2099==2&AI_PM_RC_CO2_Jarvis_H_Princeton==1)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_Princeton==1)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_2070_2099==6&AI_PM_RC_CO2_Jarvis_H_Princeton==1)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_Princeton==1)) .*100];
% 1948-2014 subhumid converted to What
M_PM_RC_Jarvis_H(2,:) =...
    [nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_2070_2099==1&AI_PM_RC_CO2_Jarvis_H_Princeton==2)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_Princeton==2)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_2070_2099==2&AI_PM_RC_CO2_Jarvis_H_Princeton==2)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_Princeton==2)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_2070_2099==6&AI_PM_RC_CO2_Jarvis_H_Princeton==2)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_Princeton==2)) .*100];
% 1948-2014 3 converted to What
M_PM_RC_Jarvis_H(3,:) =...
    [nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_2070_2099==1&AI_PM_RC_CO2_Jarvis_H_Princeton==6)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_Princeton==6)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_2070_2099==2&AI_PM_RC_CO2_Jarvis_H_Princeton==6)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_Princeton==6)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_2070_2099==6&AI_PM_RC_CO2_Jarvis_H_Princeton==6)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Jarvis_H_Princeton==6)) .*100];
%% PM_RC_Yang
% 1948-2014 Humid converted to What
M_PM_RC_Yang(1,:) =...
    [nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_2070_2099==1&AI_PM_RC_CO2_Yang_Princeton==1)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_Princeton==1)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_2070_2099==2&AI_PM_RC_CO2_Yang_Princeton==1)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_Princeton==1)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_2070_2099==6&AI_PM_RC_CO2_Yang_Princeton==1)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_Princeton==1)) .*100];
% 1948-2014 subhumid converted to What
M_PM_RC_Yang(2,:) =...
    [nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_2070_2099==1&AI_PM_RC_CO2_Yang_Princeton==2)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_Princeton==2)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_2070_2099==2&AI_PM_RC_CO2_Yang_Princeton==2)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_Princeton==2)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_2070_2099==6&AI_PM_RC_CO2_Yang_Princeton==2)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_Princeton==2)) .*100];
% 1948-2014 3 converted to What
M_PM_RC_Yang(3,:) =...
    [nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_2070_2099==1&AI_PM_RC_CO2_Yang_Princeton==6)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_Princeton==6)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_2070_2099==2&AI_PM_RC_CO2_Yang_Princeton==6)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_Princeton==6)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_2070_2099==6&AI_PM_RC_CO2_Yang_Princeton==6)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_CO2_Yang_Princeton==6)) .*100];
%% PM_RC
% 1948-2014 Humid converted to What
M_PM_RC(1,:) =...
    [nansum(EarthLandArea_05deg(AI_PM_RC_2070_2099==1&AI_PM_RC_Princeton==1)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_Princeton==1)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_2070_2099==2&AI_PM_RC_Princeton==1)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_Princeton==1)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_2070_2099==6&AI_PM_RC_Princeton==1)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_Princeton==1)) .*100];
% 1948-2014 subhumid converted to What
M_PM_RC(2,:) =...
    [nansum(EarthLandArea_05deg(AI_PM_RC_2070_2099==1&AI_PM_RC_Princeton==2)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_Princeton==2)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_2070_2099==2&AI_PM_RC_Princeton==2)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_Princeton==2)) .*100,...
    nansum(EarthLandArea_05deg(AI_PM_RC_2070_2099==6&AI_PM_RC_Princeton==2)) ./ nansum(EarthLandArea_05deg(AI_PM_RC_Princeton==2)) .*100];
% 1948-2014 3 converted to What
M_PM_RC(3,:) =...
...
xlswrite([Path_Fig2_Output 'TransferMatrix_EnsembleMean.xlsx'] , M_PM_RC , sspName , 'M4:O6');
xlswrite([Path_Fig2_Output 'TransferMatrix_EnsembleMean.xlsx'] , M_PM_RC_Yang , sspName , 'M16:O18');
xlswrite([Path_Fig2_Output 'TransferMatrix_EnsembleMean.xlsx'] , M_PM_RC_Jarvis_H , sspName , 'M28:O30');
end