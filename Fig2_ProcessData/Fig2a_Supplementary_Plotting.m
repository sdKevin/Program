...
if 1==1
    ...
    fill([[1850:2100]';flipud([1850:2100]')],...
        ...
        RGB_Cold_Shade./255,'EdgeAlpha',0,'FaceAlpha',0.3);hold on;
    ...
    plot([1948:2014],smooth(HumidLand_PM_RC,7),'--',...
        'Color',1.0-1*(1.0-[102,194,165]./255),'EraseMode','xor','Linewidth',2.5);
    ...
    % Dry and Humid
    subplot(1,9,[1:6])
    H = notBoxPlot([mean(DryLand_PM_RC(:,1:30)')',mean(DryLand_PM_RC(:,99:165)')',...
        mean(DryLand_PM_RC(:,221:250)')',...
        mean(HumidLand_PM_RC(:,1:30)')',mean(HumidLand_PM_RC(:,99:165)')',...
        mean(HumidLand_PM_RC(:,221:250)')'],[]);
    ...
    % Cold
    subplot(1,9,[7:9])
    H = notBoxPlot([mean(Cold_PM_RC(:,1:30)')',mean(Cold_PM_RC(:,99:195)')',...
        mean(Cold_PM_RC(:,221:250)')'],[]);
    set(gca,'color',[ 255 255 255]./255,'Box','On')
...
if 2==2
    ...
    % Dry and Humid
    subplot(1,9,[1:6])
    H = notBoxPlot([mean(DryLand_PM_RC_CO2_Yang(:,1:30)')',mean(DryLand_PM_RC_CO2_Yang(:,99:165)')',...
        mean(DryLand_PM_RC_CO2_Yang(:,221:250)')',...
        mean(HumidLand_PM_RC_CO2_Yang(:,1:30)')',mean(HumidLand_PM_RC_CO2_Yang(:,99:165)')',...
        mean(HumidLand_PM_RC_CO2_Yang(:,221:250)')'],[]);
    set(gca,'color',[ 255 255 255]./255,'Box','On')
    set([H.data],'MarkerSize',6,...
        'markerFaceColor',[77,77,77]./255,...
        'markerEdgeColor', 'none')
    % DryLand_PM_RC_CO2_Yang
    set([H(1).sdPtch],'EdgeColor','none','FaceAlpha',0)%delete 1std
    set([H(1).mu],'Color',1.0-1*(1.0-RGB_Dry_Line./255),'EraseMode','xor')
    set([H(1).semPtch],'FaceColor',RGB_Dry_Shade./255,'FaceAlpha',0.5,'EdgeColor','none')
    ...
    % Cold
    subplot(1,9,[7:9])
    H = notBoxPlot([mean(Cold_PM_RC_CO2_Yang(:,1:30)')',mean(Cold_PM_RC_CO2_Yang(:,99:195)')',...
        mean(Cold_PM_RC_CO2_Yang(:,221:250)')'],[]);
    set(gca,'color',[ 255 255 255]./255,'Box','On')
    set([H.data],'MarkerSize',5,...
        'markerFaceColor',[77,77,77]./255,...
        'markerEdgeColor','none' )
