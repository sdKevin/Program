...
%% LAI ssp245 Data
load LandInfo_05deg
LAI_Path_Data = 'D:\CMIP6\VariableStorage\YearlyVar\Var_Veg\ScenarioMIP_ssp245\Veg_Var_ssp245_Ensemble_Veg_Var_LAI.mat';
load(LAI_Path_Data);
...
save('D:\CMIP6\VariableStorage\ImplicationResearch\Risk_ssp245.mat','Risk','lat','lon')
%% Output Figure
...
% Risk Layer
Risk(isnan(Risk)) = -1;
SaveData2GeoTIFF(['Fig3_OutputTable\Risk_245.tif' ],...
    extent , Risk);
% Hazard Layer
Hazard(isnan(Hazard)) = -1;
SaveData2GeoTIFF(['Fig3_OutputTable\Hazard_245.tif' ],...
    extent , Hazard);
% Exposure Layer
Exposure(isnan(Exposure)) = -1;
SaveData2GeoTIFF(['Fig3_OutputTable\Exposure_245.tif' ],...
    extent , Exposure);
% Vulnerability Layer
Vulnerability(isnan(Vulnerability)) = -1;
SaveData2GeoTIFF(['Fig3_OutputTable\Vulnerability_245.tif' ],...
