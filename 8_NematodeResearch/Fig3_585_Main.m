...
SaveData2GeoTIFF(['Fig3_OutputTable\Hazard_585.tif' ],...
    extent , Hazard);
% Exposure Layer
Exposure(isnan(Exposure)) = -1;
SaveData2GeoTIFF(['Fig3_OutputTable\Exposure_585.tif' ],...
    extent , Exposure);
% Vulnerability Layer
Vulnerability(isnan(Vulnerability)) = -1;
SaveData2GeoTIFF(['Fig3_OutputTable\Vulnerability_585.tif' ],...
