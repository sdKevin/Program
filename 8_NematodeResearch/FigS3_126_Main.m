...
%% Percentage Change of Runoff ssp126 Data
load LandInfo_05deg
Runoff_Path_Data = 'D:\CMIP6\VariableStorage\ClimatologicalChange\PerChange_ssp126.mat';
...
%% Runoff ssp126 Data
load LandInfo_05deg
Runoff_Path_Data = 'D:\CMIP6\VariableStorage\YearlyVar\Var_Land\ScenarioMIP_ssp126\Land_Var_ssp126_Ensemble_Land_Var_Mrro.mat';
load(Runoff_Path_Data);
...
%% LAI ssp126 Data
load LandInfo_05deg
LAI_Path_Data = 'D:\CMIP6\VariableStorage\YearlyVar\Var_Veg\ScenarioMIP_ssp126\Veg_Var_ssp126_Ensemble_Veg_Var_LAI.mat';
load(LAI_Path_Data);
...
%% Total Population ssp126 Data
Population_Path_Data = 'D:\CMIP6\ProcessData\ImplicationResearch\Global Population Projection Grids Based on SSPs\SSP1\Total\Mat\ssp1_2100.mat';
load(Population_Path_Data);clear Population_Path_Data
Population_Path_Data = 'D:\CMIP6\ProcessData\ImplicationResearch\Global Population Projection Grids Based on SSPs\SSP1\Total\Mat\lat.mat';
load(Population_Path_Data);clear Population_Path_Data
Population_Path_Data = 'D:\CMIP6\ProcessData\ImplicationResearch\Global Population Projection Grids Based on SSPs\SSP1\Total\Mat\lon.mat';
load(Population_Path_Data);clear Population_Path_Data
% Adjust to uniform Coordinate
...
%% Rural Population ssp126 Data
Population_Path_Data = 'D:\CMIP6\ProcessData\ImplicationResearch\Global Population Projection Grids Based on SSPs\SSP1\Rural\Mat\ssp1rur2100.mat';
load(Population_Path_Data);clear Population_Path_Data
Population_Path_Data = 'D:\CMIP6\ProcessData\ImplicationResearch\Global Population Projection Grids Based on SSPs\SSP1\Rural\Mat\lat.mat';
load(Population_Path_Data);clear Population_Path_Data
Population_Path_Data = 'D:\CMIP6\ProcessData\ImplicationResearch\Global Population Projection Grids Based on SSPs\SSP1\Rural\Mat\lon.mat';
load(Population_Path_Data);clear Population_Path_Data
% Adjust to uniform Coordinate
A = Population(1:1440,:); B = Population(1441:end,:);
Population = [B;A]; clear A B
...
save('D:\CMIP6\VariableStorage\ImplicationResearch\Hazard_ssp126.mat','Hazard','lat','lon');
...
save('D:\CMIP6\VariableStorage\ImplicationResearch\Exposure_ssp126.mat','Exposure','lat','lon')
