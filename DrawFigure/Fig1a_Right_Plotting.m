...
figure
% Dry and Humid for ssp126,245,585
subplot(1,12,[1:6])
H = notBoxPlot([mean(CMIP_DryWetRegion(2).DryLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')',...
    ...
    mean(CMIP_DryWetRegion(5).DryLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(2).HumidLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(3).HumidLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')',...
    mean(CMIP_DryWetRegion(5).HumidLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')'],[]);
...
H = notBoxPlot([mean(CMIP_DryWetRegion(2).Cold_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')',...
    ...
    mean(CMIP_DryWetRegion(5).Cold_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')'],[]);
set(gca,'color',[ 255 255 255]./255,'Box','On')
set([H.data],'MarkerSize',6,...
    'markerFaceColor','none',...
    'markerEdgeColor', 'none')
