...
for i_ssp = 1 : length(ssp)
    ...
    SaveData2GeoTIFF([Path_Fig2b2d_Output 'PerChange_AI_' ssp{i_ssp}],...
        extent , Ensemble_Mean_PerChange_AI');
    SaveData2GeoTIFF([Path_Fig2b2d_Output 'consistency_PerChange_AI_' ssp{i_ssp}],...
    ...
    SaveData2GeoTIFF([Path_Fig2b2d_Output 'PerChange_pr_evspsbl_' ssp{i_ssp}],...
        extent , Ensemble_Mean_PerChange_pr_evspsbl');
    SaveData2GeoTIFF([Path_Fig2b2d_Output 'consistency_PerChange_pr_evspsbl_' ssp{i_ssp}],...
    ...
    SaveData2GeoTIFF([Path_Fig2b2d_Output 'PerChange_mrro_' ssp{i_ssp}],...
        extent , Ensemble_Mean_PerChange_mrro');
    SaveData2GeoTIFF([Path_Fig2b2d_Output 'consistency_PerChange_mrro_' ssp{i_ssp}],...
    ...
    SaveData2GeoTIFF([Path_Fig2b2d_Output 'PerChange_mrso_' ssp{i_ssp}],...
