...
for ii = 4 : -1 : 1
    ...
    elseif ii==3
        xlswrite([Path_Fig2a_Output '80% confidence interval.xlsx'] , A , 'Confidence interval' , 'B18:I18');
        xlswrite([Path_Fig2a_Output '80% confidence interval.xlsx'] , B , 'Confidence interval' , 'B19:I19');
    elseif ii==2
        xlswrite([Path_Fig2a_Output '80% confidence interval.xlsx'] , A , 'Confidence interval' , 'B11:I11');
        xlswrite([Path_Fig2a_Output '80% confidence interval.xlsx'] , B , 'Confidence interval' , 'B12:I12');
    else
        xlswrite([Path_Fig2a_Output '80% confidence interval.xlsx'] , A , 'Confidence interval' , 'B4:I4');
        xlswrite([Path_Fig2a_Output '80% confidence interval.xlsx'] , B , 'Confidence interval' , 'B5:I5');
    end
    clear A B
end
