...
H = notBoxPlot([mean(CMIP_DryWetRegion(2).DryLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')',...
    ...
    mean(CMIP_DryWetRegion(5).DryLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')'],'jitter',0.3);
...
H = notBoxPlot([mean(CMIP_DryWetRegion(2).HumidLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')',...
    ...
    mean(CMIP_DryWetRegion(5).HumidLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')'],'jitter',0.4);
set(gca,'color',[ 255 255 255]./255,'Box','On')
set([H.data],'MarkerSize',6,...
    'markerFaceColor','none',...
    'markerEdgeColor', 'none')
...
set([H(1).semPtch],'FaceColor',RGB_Humid_Shade./255,'FaceAlpha',0,'EdgeColor',RGB_Humid_Line./255,'LineWidth',1.5)

set([H(2).sdPtch],'EdgeColor','none','FaceAlpha',0); %delete 1 std
set([H(2).mu],'Color',1.0-1*(1.0-RGB_Humid_Line./255),'EraseMode','xor')
set([H(2).semPtch],'FaceColor',RGB_Humid_Shade./255,'FaceAlpha',0,'EdgeColor',RGB_Humid_Line./255,'LineWidth',1.5)

set([H(3).sdPtch],'EdgeColor','none','FaceAlpha',0); %delete 1 std
set([H(3).mu],'Color',1.0-1*(1.0-RGB_Humid_Line./255),'EraseMode','xor')
set([H(3).semPtch],'FaceColor',RGB_Humid_Shade./255,'FaceAlpha',0,'EdgeColor',RGB_Humid_Line./255,'LineWidth',1.5)
...
H = notBoxPlot([mean(CMIP_DryWetRegion(4).DryLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')',...
    ...
    mean(CMIP_DryWetRegion(4).DryLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')'],'jitter',0.3);
set(gca,'color',[ 255 255 255]./255,'Box','On')
set([H.data],'MarkerSize',6,...
    'markerFaceColor','none',...
    'markerEdgeColor', 'none')
...
H = notBoxPlot([mean(CMIP_DryWetRegion(4).HumidLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')',...
    ...
    mean(CMIP_DryWetRegion(4).HumidLand_PM_RC_CO2_Jarvis_H(:,end-30:end-1)')'],'jitter',0.4);
set(gca,'color',[ 255 255 255]./255,'Box','On')
set([H.data],'MarkerSize',6,...
    'markerFaceColor','none',...
    'markerEdgeColor', 'none')
